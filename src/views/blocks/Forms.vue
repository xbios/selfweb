      ...
      <b-row>
          ...
          <b-form @submit="onSubmit" @reset="onReset">
            <base-block title="Block Form" header-bg>
              <template #options>
                ...
                <b-button type="reset" size="sm" variant="outline-danger">Reset</b-button>
              </template>
              <b-row class="justify-content-center py-sm-3 py-md-5">
                <b-col sm="10" md="8">
        ...
        <b-col md="6">
          <b-form @submit="onSubmit" @reset="onReset">
            <base-block title="Block Form" header-bg>
              <template #options>
                <b-button type="submit" size="sm" variant="alt-primary">Submit</b-button>
                <b-button type="reset" size="sm" variant="alt-danger">Reset</b-button>
              </template>
              <b-row class="justify-content-center py-sm-3 py-md-5">
                <b-col sm="10" md="8">
