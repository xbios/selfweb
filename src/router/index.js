...
const Landing = () => import("@/views/pages/auth/SignIn.vue");
...
//Backend: Cari
const cariList = () => import("@/views/cari/cariList.vue");
const cariGrup = () => import("@/views/cari/carigrup.vue");
const borcAlacakDurum = () => import("@/views/cari/borcalacakdurum.vue");
const cariEkstre = () => import("@/views/cari/cariekstre.vue");
const gunsonu = () => import("@/views/cari/gunsonu.vue");

//Backend: Stok
const stokList = () => import("@/views/stok/stokList.vue");
const stokgrup = () => import("@/views/stok/stokgrup.vue");
const stokcariekstre = () => import("@/views/stok/stokcariekstre.vue");
      ...
      children: [
...

        {
          ...
          children: [
            ...
            {
              path: "borcalacakdurum",
              name: "borc alacak durum",
              component: borcAlacakDurum
            },
            {
              path: "cariekstre",
              name: "Cari Ekstre",
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              component: stokcariekstre
            }
          ]
        },
        {
          path: "fatura",
          redirect: "/fatura/faturaList",
          component: {
            render(c) {
              return c("router-view");
            }
